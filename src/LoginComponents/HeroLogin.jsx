...
function HeroLogin() {
    ...
    return (
        <div>
            ...
            <h4 className='oswald shadow-text text-center valeurs'>À chacun son wagon bien-être à bord de la Loukoumotiv’</h4>

            <div className='d-flex justify-content-center trois-blocs-login'>
                <div>
